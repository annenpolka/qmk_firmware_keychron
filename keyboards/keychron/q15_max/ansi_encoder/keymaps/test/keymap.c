...
// メールアドレス入力用のコンボキー定義
const uint16_t PROGMEM email_combo[] = {KC_SCLN, KC_QUOT, COMBO_END};

combo_t key_combos[] = {
    [EM_EMAIL] = COMBO_ACTION(email_combo),
};

// Escape/Caps Lockタップダンス
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_66(
        ...
        TD(TD_ESC_CAPS), KC_Q, KC_W,  KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,   KC_RBRC,  KC_BSLS,
